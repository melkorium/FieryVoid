...
//Debug::log("this->ballisticWeapon " . $this->ballisticWeapon); 	
//Debug::log("mine->activated " . $mine->activated); 	
...
//Debug::log("gamedata->phase " . $gamedata->phase);
						if($gamedata->phase == 1){
							$type = "ballistic";
						}else{
							$type = "normal";
