...
class dewMineBT extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->addPrimarySystem(new MineControllerDEW(0, 1, 0, 4, 8)); //$armour, $maxhealth, $powerReq, $startArc, $endArc, $range/output, $accuracy 
