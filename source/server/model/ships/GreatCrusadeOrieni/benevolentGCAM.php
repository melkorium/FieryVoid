<?php
class BenevolentGCAM extends BaseShip{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "BenevolentGCAM";
        $this->imagePath = "img/ships/GCbenevolent.png";
        $this->shipClass = "Benevolent Heavy Scout (2248)";
	    $this->isd = 2248;
        $this->limited = 33;
        ...
        $this->addPrimarySystem(new ElintScanner(5, 25, 8, 11));
