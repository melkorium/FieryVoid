<?php
class dewMineTravikA extends Mine{
    ...
    function __construct($id, $userid, $name,  $slot){
        ...
        $this->phpclass = "dewMineTravikA";
        $this->imagePath = "img/ships/dilgarMine.png";
        $this->shipClass = "Travik-A DEW Mine";
		$this->occurence = "common";
		//$this->variantOf = "Lvast-A DEW Mine";
        $this->isd = 2200;
        ...
        $this->addPrimarySystem(new MediumLaser(0, 1, 0, 0, 360));
